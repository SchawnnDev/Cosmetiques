 ...
 *  *
 *  * This file (fr.schawnndev.particules.particules.ParticleNotes) is part of LCCosmetiques.
 *  *
...
public class ParticleNotes extends Particle {

    @Getter
    public Cosmetique cosmetique = Cosmetique.NOTES;
    ...
    public void startParticle(final UUID uuid) {
        ...
        ParticleManager.getActiveParticles().put(uuid, "notes");
